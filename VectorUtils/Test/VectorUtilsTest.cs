namespace VectorUtils.Test
{
    public class VectorUtilsTest
    {
        public VectorUtilsTest()
        {
            ...
            void TestOperator(VectorUtilTestOperator vectorUtilTestOperator)
            {
                Console.WriteLine();
                    ...
                    case VectorUtilTestOperator.VectorIntAddition:
                        {
                            ...
                            Vector3 inputVector = ReadVector3("Creating Vector:");
                            Console.WriteLine();
                            int inputInt = ReadInt("Please enter an integer:");
            ...
            void TestMethod(VectorUtilTestMethod vectorUtilTestMethod)
            {
            ...
            Vector3[] ReadVector3Array(string message)
            {
            GetArrayLength:
                int arrayLength = ReadInt("Enter Array Length:");
                if (arrayLength < 1)
                {
            ...
            Vector3 ReadVector3(string message)
            {
                Console.WriteLine(message);
                int x = ReadInt("Please enter an integer for the x component:");
                int y = ReadInt("Please enter an integer for the y component:");
                int z = ReadInt("Please enter an integer for the z component:");
            ...
            ReadInput:
                Console.WriteLine(message);
                string? consoleInput = Console.ReadLine();
                bool parseIntSuccess = int.TryParse(consoleInput, out int inputInt);
                if (!parseIntSuccess)
                {
